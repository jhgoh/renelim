...
// where the solution can be found with sine-intetral (TMath::sinint) and cosine-integrals (TMath::cosint).
...
protected:
  ...
  TMatrixD a3Mat_, b2Mat_, c1Mat_;
  std::vector<double> pEnvs_;
